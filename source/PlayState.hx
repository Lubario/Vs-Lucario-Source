...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
            ...
            case 'townbroken': //Week 7
				var bg:BGSprite = new BGSprite('townbrokenback', -600, -200, 0.9, 0.9);
				add(bg);

			case 'expurgation': //Week 7
				var bg:BGSprite = new BGSprite('expurgation', -600, -200, 0.9, 0.9);
				add(bg);
		}
		...
		boyfriend = new Boyfriend(0, 0, TestState.character);
